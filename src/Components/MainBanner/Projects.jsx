...
const technologiesData = [
  ...
  { image: beemtech, alt: "beemtech", url: "" },
];
          ...
          <div className="col-12 col-md-6">
            <div className="section-title">
              ...
              <ul className="list-style">
                <li><span ><Link to="" target="_blank" className="span-link">Skill Technologies :</Link></span>Independently developed and maintained high-performance applications, contributing to the company's innovative offerings.</li>
                <li><span ><Link to="" target="_blank" className="span-link">Trivedhi Clerical Solution  :</Link></span>Played a pivotal role in enhancing user interfaces and optimizing performance, delivering a refined user experience for this reputed service provider.</li>
                ...
                <li><span ><Link to="" target="_blank" className="span-link">Beemtech Infra llp :</Link></span>Developed the front-end for their construction website, delivering a robust and scalable user interface that drives this tech enterprise forward.</li>
              </ul>
            </div>
